...
def main() -> int:
    ...
    group.add_argument("--phase", choices=["phase1", "phase2", "phase3", "phase4", "phase5", "phase8", "phase83", "phase84", "phase85", "phase90", "phase91", "phase92", "phase93", "phase94", "phase95", "phase96", "phase97", "phase98", "phase99", "threat_hunting"], help="Run one phase marker.")
