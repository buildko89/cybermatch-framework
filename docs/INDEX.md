# CyberMatch Documentation Index

This index is the primary entry point for CyberMatch documentation.

## Vision

- [CyberMatch Vision](CYBERMATCH_VISION.md)
- [CyberMatch End-State Definition](CYBERMATCH_END_STATE.md)
- [CyberMatch Status](CYBERMATCH_STATUS.md)
...
- [CyberMatch Roadmap](CYBERMATCH_ROADMAP.md)

## Phase Reports

- [Phase1 Final Report](CYBERMATCH_PHASE1_FINAL_REPORT.md)
- [Phase2 Final Report](CYBERMATCH_PHASE2_FINAL_REPORT.md)
- [Phase3-A Final Report](CYBERMATCH_PHASE3A_FINAL_REPORT.md)
...
- [Phase1 Artifacts](PHASE1_ARTIFACTS.md)
- [Phase2 Artifacts](PHASE2_ARTIFACTS.md)
- [Phase3-A Artifacts](PHASE3A_ARTIFACTS.md)
- [Phase3-B Artifacts](PHASE3B_ARTIFACTS.md)
- [Phase4 Artifacts](PHASE4_ARTIFACTS.md)

Generated artifacts are written to `output/` and are intentionally excluded from git.
