...
HUNT_EVENT_FIELDS = frozenset(
    {
        ...
        "attributes.ordinal",
        "attributes.telemetry_family",
        "attributes.success_observed",
        "attributes.detection_observed",
        "attributes.auth_method",
        "attributes.auth_result",
        "attributes.credential_present",
        "attributes.process_name",
        "attributes.parent_process",
        "attributes.process_signed",
        "attributes.process_masquerading",
        "attributes.query_name",
        "attributes.tunnel_chunk_size",
        "attributes.domain_homoglyph",
        "attributes.protocol",
        "attributes.bytes",
        "attributes.c2_jitter_ratio",
        "attributes.task_id",
        "attributes.tool_name",
        "attributes.service",
        "attributes.channel",
        "attributes.boundary",
        "attributes.destination_scope",
        "attributes.credential_scope",
        "attributes.resource_id",
        "attributes.action_risk",
        "attributes.advisory_id",
